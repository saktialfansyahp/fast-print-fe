...
export default {
  ...
  methods: {
    ...
    fetchData() {
      axios
        .get("/api/produk/" + this.product_id)
        .then((response) => {
          console.log(response);
          this.product = {
          ...
          this.formattedPrice = this.product.harga.toLocaleString("id-ID");
          this.selectedStatus = response.data.data.Status;
          this.selectedKategori = response.data.data.Kategori;
        })
        .catch((error) => {
          console.log(error);
        });
    ...
    editProduct() {
      ...
      axios
        .put("/api/produk/" + this.product_id, this.product)
        .then((response) => {
